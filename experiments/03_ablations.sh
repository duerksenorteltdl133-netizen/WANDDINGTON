...
# Each ablation is run paired against the full C arm (waddington_v14)
...
run_ablation "C - memory"         waddington_v14_no_memory   ablation_memory.json
run_ablation "C - LLM"            waddington_v14_no_llm      ablation_llm.json
run_ablation "C - ML (retrain)"   waddington_v14_no_ml       ablation_ml.json
run_ablation "C - shuffled names" waddington_v14_shuffled_names ablation_shuffled.json
